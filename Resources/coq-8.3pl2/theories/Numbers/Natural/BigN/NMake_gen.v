...
Module Make (Import W0:CyclicType).
 ...
 intros n Hrec ww ww_op; simpl DoubleBase.double_digits.
 rewrite <- Hrec; auto.
 Qed.
 ...
 rewrite <- Hrec; auto.
 unfold DoubleBase.double_wB; rewrite <- digits_doubled; auto.
 Qed.
 ...
 Proof.
  intros n; exact (nmake_double n w0 w0_op).
 Qed.
 ...
 Proof.
  intros n; exact (nmake_double n w1 w1_op).
 Qed.
 ...
 Proof.
  intros n; exact (nmake_double n w2 w2_op).
 Qed.
 ...
 Proof.
  intros n; exact (nmake_double n w3 w3_op).
 Qed.
 ...
 Proof.
  intros n; exact (nmake_double n w4 w4_op).
 Qed.
 ...
 Proof.
  intros n; exact (nmake_double n w5 w5_op).
 Qed.
 ...
 Proof.
  intros n; exact (nmake_double n w6 w6_op).
 Qed.
 ...
 Proof.
 intros x; rewrite spec_double_eval0n; unfold DoubleBase.double_to_Z, to_Z; auto.
 Qed.
 ...
 Proof.
 intros x; rewrite spec_double_eval1n; unfold DoubleBase.double_to_Z, to_Z; auto.
 Qed.
 ...
 Proof.
 intros x; rewrite spec_double_eval2n; unfold DoubleBase.double_to_Z, to_Z; auto.
 Qed.
 ...
 Proof.
 intros x; rewrite spec_double_eval3n; unfold DoubleBase.double_to_Z, to_Z; auto.
 Qed.
 ...
 Proof.
 intros x; rewrite spec_double_eval4n; unfold DoubleBase.double_to_Z, to_Z; auto.
 Qed.
 ...
 Proof.
 intros x; rewrite spec_double_eval5n; unfold DoubleBase.double_to_Z, to_Z; auto.
 Qed.
 ...
 Proof.
 intros x; rewrite spec_double_eval6n; unfold DoubleBase.double_to_Z, to_Z; auto.
 Qed.
 ...
 Definition compare := Eval lazy beta delta [iter] in
   (iter _
      compare_0
      (fun n x y => CompOpp (comparen_0 (S n) y x))
      (fun n => comparen_0 (S n))
      compare_1
      (fun n x y => CompOpp (comparen_1 (S n) y x))
      (fun n => comparen_1 (S n))
      compare_2
      (fun n x y => CompOpp (comparen_2 (S n) y x))
      (fun n => comparen_2 (S n))
      compare_3
      (fun n x y => CompOpp (comparen_3 (S n) y x))
      (fun n => comparen_3 (S n))
      compare_4
      (fun n x y => CompOpp (comparen_4 (S n) y x))
      (fun n => comparen_4 (S n))
      compare_5
      (fun n x y => CompOpp (comparen_5 (S n) y x))
      (fun n => comparen_5 (S n))
      compare_6
      (fun n x y => CompOpp (comparen_6 (S n) y x))
 ...
 Let spec_compare_0: forall x y,
  ...
  intros n x y.
  unfold comparen_0, to_Z; rewrite spec_double_eval0n.
 ...
 Let spec_compare_1: forall x y,
  ...
  intros n x y.
  unfold comparen_1, to_Z; rewrite spec_double_eval1n.
  apply spec_compare_mn_1.
 ...
 Let spec_compare_2: forall x y,
  ...
  intros n x y.
  unfold comparen_2, to_Z; rewrite spec_double_eval2n.
  apply spec_compare_mn_1.
 ...
 Let spec_compare_3: forall x y,
  ...
  intros n x y.
  unfold comparen_3, to_Z; rewrite spec_double_eval3n.
  apply spec_compare_mn_1.
 ...
 Let spec_compare_4: forall x y,
  ...
  intros n x y.
  unfold comparen_4, to_Z; rewrite spec_double_eval4n.
  apply spec_compare_mn_1.
 ...
 Let spec_compare_5: forall x y,
  ...
  intros n x y.
  unfold comparen_5, to_Z; rewrite spec_double_eval5n.
  apply spec_compare_mn_1.
 ...
 Let spec_compare_6: forall x y,
  ...
  intros n x y.
  unfold comparen_6, to_Z; rewrite spec_double_eval6n.
  apply spec_compare_mn_1.
 ...
 Let spec_opp_compare: forall c (u v: Z),
  ...
  match CompOpp c with Eq => v = u | Lt => v < u | Gt => v > u end.
 Proof.
 intros c u v; case c; unfold CompOpp; auto with zarith.
 Qed.

 Theorem spec_compare_aux: forall x y,
...
Theorem to_Z5_spec:
 ...
 change (base (DoubleBase.double_digits (znz_digits w0_op) n)) with
        (DoubleBase.double_wB (znz_digits w0_op) n).
 apply spec_double_mul_add_n1; auto.
 exact (spec_0 w0_spec).
 ...
 rewrite nmake_double.
 rewrite digits_doubled.
 change (base (DoubleBase.double_digits (znz_digits w1_op) n)) with
        (DoubleBase.double_wB (znz_digits w1_op) n).
 apply spec_double_mul_add_n1; auto.
 ...
 rewrite nmake_double.
 rewrite digits_doubled.
 change (base (DoubleBase.double_digits (znz_digits w2_op) n)) with
        (DoubleBase.double_wB (znz_digits w2_op) n).
 apply spec_double_mul_add_n1; auto.
 ...
 rewrite nmake_double.
 rewrite digits_doubled.
 change (base (DoubleBase.double_digits (znz_digits w3_op) n)) with
        (DoubleBase.double_wB (znz_digits w3_op) n).
 apply spec_double_mul_add_n1; auto.
 ...
 rewrite nmake_double.
 rewrite digits_doubled.
 change (base (DoubleBase.double_digits (znz_digits w4_op) n)) with
        (DoubleBase.double_wB (znz_digits w4_op) n).
 apply spec_double_mul_add_n1; auto.
 ...
 rewrite nmake_double.
 rewrite digits_doubled.
 change (base (DoubleBase.double_digits (znz_digits w5_op) n)) with
        (DoubleBase.double_wB (znz_digits w5_op) n).
 apply spec_double_mul_add_n1; auto.
 ...
 rewrite nmake_double.
 rewrite digits_doubled.
 change (base (DoubleBase.double_digits (znz_digits w6_op) n)) with
        (DoubleBase.double_wB (znz_digits w6_op) n).
 apply spec_double_mul_add_n1; auto.
 ...
 Qed.
  ...
  znz_to_Z w0_op x1.
  Proof.
    intros n1 x2; rewrite nmake_double.
    unfold extend0.
    rewrite DoubleBase.spec_extend; auto.
...
Qed.
 ...
 Proof.
 intros n x y H.
 rewrite spec_double_eval0n; unfold to_Z.
 apply DoubleBase.spec_get_low.
 exact (spec_0 w0_spec).
 exact (spec_to_Z w0_spec).
 apply Zle_lt_trans with [N0 y]; auto.
   rewrite <- spec_double_eval0n; auto.
 ...
 Proof.
 intros n x y H.
 rewrite spec_double_eval1n; unfold to_Z.
 apply DoubleBase.spec_get_low.
 exact (spec_0 w1_spec).
 exact (spec_to_Z w1_spec).
 apply Zle_lt_trans with [N1 y]; auto.
   rewrite <- spec_double_eval1n; auto.
 ...
 Proof.
 intros n x y H.
 rewrite spec_double_eval2n; unfold to_Z.
 apply DoubleBase.spec_get_low.
 exact (spec_0 w2_spec).
 exact (spec_to_Z w2_spec).
 apply Zle_lt_trans with [N2 y]; auto.
   rewrite <- spec_double_eval2n; auto.
 ...
 Proof.
 intros n x y H.
 rewrite spec_double_eval3n; unfold to_Z.
 apply DoubleBase.spec_get_low.
 exact (spec_0 w3_spec).
 exact (spec_to_Z w3_spec).
 apply Zle_lt_trans with [N3 y]; auto.
   rewrite <- spec_double_eval3n; auto.
 ...
 Proof.
 intros n x y H.
 rewrite spec_double_eval4n; unfold to_Z.
 apply DoubleBase.spec_get_low.
 exact (spec_0 w4_spec).
 exact (spec_to_Z w4_spec).
 apply Zle_lt_trans with [N4 y]; auto.
   rewrite <- spec_double_eval4n; auto.
 ...
 Proof.
 intros n x y H.
 rewrite spec_double_eval5n; unfold to_Z.
 apply DoubleBase.spec_get_low.
 exact (spec_0 w5_spec).
 exact (spec_to_Z w5_spec).
 apply Zle_lt_trans with [N5 y]; auto.
   rewrite <- spec_double_eval5n; auto.
 ...
 Proof.
 intros n x y H.
 rewrite spec_double_eval6n; unfold to_Z.
 apply DoubleBase.spec_get_low.
 exact (spec_0 w6_spec).
 exact (spec_to_Z w6_spec).
 apply Zle_lt_trans with [N6 y]; auto.
   rewrite <- spec_double_eval6n; auto.
...
unfold w0; case znz_div_gt.
  ...
  intros n x y H1 H2 H3.
    ...
    unfold w0_divn1; unfold w0; case double_divn1.
    intros xx yy H4.
    rewrite to_Z0_spec; auto with zarith.
    repeat rewrite <- spec_double_eval0n in H4; auto.
...
unfold w1; unfold w0; case znz_div_gt.
  ...
  intros n x y H1 H2 H3.
    ...
    unfold w1_divn1; unfold w1; unfold w0; case double_divn1.
    intros xx yy H4.
    rewrite to_Z1_spec; auto with zarith.
    repeat rewrite <- spec_double_eval1n in H4; auto.
...
unfold w2; unfold w1; unfold w0; case znz_div_gt.
  ...
  intros n x y H1 H2 H3.
    ...
    unfold w2_divn1; unfold w2; unfold w1; unfold w0; case double_divn1.
    intros xx yy H4.
    rewrite to_Z2_spec; auto with zarith.
    repeat rewrite <- spec_double_eval2n in H4; auto.
...
unfold w3; unfold w2; unfold w1; unfold w0; case znz_div_gt.
  ...
  intros n x y H1 H2 H3.
    ...
    unfold w3_divn1; unfold w3; unfold w2; unfold w1; unfold w0; case double_divn1.
    intros xx yy H4.
    rewrite to_Z3_spec; auto with zarith.
    repeat rewrite <- spec_double_eval3n in H4; auto.
...
unfold w4; unfold w3; unfold w2; unfold w1; unfold w0; case znz_div_gt.
  ...
  intros n x y H1 H2 H3.
    ...
    unfold w4_divn1; unfold w4; unfold w3; unfold w2; unfold w1; unfold w0; case double_divn1.
    intros xx yy H4.
    rewrite to_Z4_spec; auto with zarith.
    repeat rewrite <- spec_double_eval4n in H4; auto.
...
unfold w5; unfold w4; unfold w3; unfold w2; unfold w1; unfold w0; case znz_div_gt.
  ...
  intros n x y H1 H2 H3.
    ...
    unfold w5_divn1; unfold w5; unfold w4; unfold w3; unfold w2; unfold w1; unfold w0; case double_divn1.
    intros xx yy H4.
    rewrite to_Z5_spec; auto with zarith.
    repeat rewrite <- spec_double_eval5n in H4; auto.
...
unfold w6; unfold w5; unfold w4; unfold w3; unfold w2; unfold w1; unfold w0; case znz_div_gt.
  ...
  intros n x y H2 H3.
    ...
    unfold w6_divn1; unfold w6; unfold w5; unfold w4; unfold w3; unfold w2; unfold w1; unfold w0; case double_divn1.
    intros xx yy H4.
    repeat rewrite <- spec_double_eval6n in H4; auto.
 ...
 intros n x y H1 H2 H3; rewrite spec_reduce_0.
 unfold w0_modn1, to_Z; rewrite spec_double_eval0n.
 ...
 intros n x y H1 H2 H3; rewrite spec_reduce_1.
 unfold w1_modn1, to_Z; rewrite spec_double_eval1n.
 ...
 intros n x y H1 H2 H3; rewrite spec_reduce_2.
 unfold w2_modn1, to_Z; rewrite spec_double_eval2n.
 ...
 intros n x y H1 H2 H3; rewrite spec_reduce_3.
 unfold w3_modn1, to_Z; rewrite spec_double_eval3n.
 ...
 intros n x y H1 H2 H3; rewrite spec_reduce_4.
 unfold w4_modn1, to_Z; rewrite spec_double_eval4n.
 ...
 intros n x y H1 H2 H3; rewrite spec_reduce_5.
 unfold w5_modn1, to_Z; rewrite spec_double_eval5n.
 ...
 intros n x y H2 H3; rewrite spec_reduce_6.
 unfold w6_modn1, to_Z; rewrite spec_double_eval6n.
 ...
 Definition unsafe_shiftr0 n x := w0_op.(znz_add_mul_div) (w0_op.(znz_sub) w0_op.(znz_zdigits) n) w0_op.(znz_0) x.
 Definition unsafe_shiftr1 n x := w1_op.(znz_add_mul_div) (w1_op.(znz_sub) w1_op.(znz_zdigits) n) w1_op.(znz_0) x.
 Definition unsafe_shiftr2 n x := w2_op.(znz_add_mul_div) (w2_op.(znz_sub) w2_op.(znz_zdigits) n) w2_op.(znz_0) x.
 Definition unsafe_shiftr3 n x := w3_op.(znz_add_mul_div) (w3_op.(znz_sub) w3_op.(znz_zdigits) n) w3_op.(znz_0) x.
 Definition unsafe_shiftr4 n x := w4_op.(znz_add_mul_div) (w4_op.(znz_sub) w4_op.(znz_zdigits) n) w4_op.(znz_0) x.
 Definition unsafe_shiftr5 n x := w5_op.(znz_add_mul_div) (w5_op.(znz_sub) w5_op.(znz_zdigits) n) w5_op.(znz_0) x.
 Definition unsafe_shiftr6 n x := w6_op.(znz_add_mul_div) (w6_op.(znz_sub) w6_op.(znz_zdigits) n) w6_op.(znz_0) x.
 Definition unsafe_shiftrn n p x := (make_op n).(znz_add_mul_div) ((make_op n).(znz_sub) (make_op n).(znz_zdigits) p) (make_op n).(znz_0) x.

 Definition unsafe_shiftr := Eval lazy beta delta [same_level] in
     same_level _ (fun n x => N0 (unsafe_shiftr0 n x))
           (fun n x => reduce_1 (unsafe_shiftr1 n x))
           (fun n x => reduce_2 (unsafe_shiftr2 n x))
           (fun n x => reduce_3 (unsafe_shiftr3 n x))
           (fun n x => reduce_4 (unsafe_shiftr4 n x))
           (fun n x => reduce_5 (unsafe_shiftr5 n x))
           (fun n x => reduce_6 (unsafe_shiftr6 n x))
           (fun n p x => reduce_n n (unsafe_shiftrn n p x)).

 Theorem spec_unsafe_shiftr: forall n x,
  [n] <= [Ndigits x] -> [unsafe_shiftr n x] = [x] / 2 ^ [n].
 Proof.
 ...
 assert (F2: forall x y z, 0 <= x -> 0 <= y -> x < z -> 0 <= x / 2 ^ y < z).
  ...
  intros ww ww1 ww2 ww_op ww1_op ww2_op xx yy xx1 yy1 Hl Hl1 Hw Hw1 Hw2 Hx Hy.
     ...
     rewrite (CyclicAxioms.spec_sub Hw).
  ...
  intros x; case x; clear x; unfold unsafe_shiftr, same_level.
    intros x y; case y; clear y.
     intros y; unfold unsafe_shiftr0, Ndigits.
     repeat rewrite spec_reduce_0; unfold to_Z; intros H1.
       apply F4 with (3:=w0_spec)(4:=w0_spec)(5:=w0_spec); auto with zarith.
     intros y; unfold unsafe_shiftr1, Ndigits.
     ...
     intros y; unfold unsafe_shiftr2, Ndigits.
     ...
     intros y; unfold unsafe_shiftr3, Ndigits.
     ...
     intros y; unfold unsafe_shiftr4, Ndigits.
     ...
     intros y; unfold unsafe_shiftr5, Ndigits.
     ...
     intros y; unfold unsafe_shiftr6, Ndigits.
     ...
     intros m y; unfold unsafe_shiftrn, Ndigits.
    ...
    intros n x y; case y; clear y;
     intros y; unfold unsafe_shiftrn, Ndigits; try rewrite spec_reduce_n.
 ...
 Definition unsafe_shiftl0 n x := w0_op.(znz_add_mul_div) n x w0_op.(znz_0).
 Definition unsafe_shiftl1 n x := w1_op.(znz_add_mul_div) n x w1_op.(znz_0).
 Definition unsafe_shiftl2 n x := w2_op.(znz_add_mul_div) n x w2_op.(znz_0).
 Definition unsafe_shiftl3 n x := w3_op.(znz_add_mul_div) n x w3_op.(znz_0).
 Definition unsafe_shiftl4 n x := w4_op.(znz_add_mul_div) n x w4_op.(znz_0).
 Definition unsafe_shiftl5 n x := w5_op.(znz_add_mul_div) n x w5_op.(znz_0).
 Definition unsafe_shiftl6 n x := w6_op.(znz_add_mul_div) n x w6_op.(znz_0).
 Definition unsafe_shiftln n p x := (make_op n).(znz_add_mul_div) p x (make_op n).(znz_0).
 Definition unsafe_shiftl := Eval lazy beta delta [same_level] in
    same_level _ (fun n x => N0 (unsafe_shiftl0 n x))
           (fun n x => reduce_1 (unsafe_shiftl1 n x))
           (fun n x => reduce_2 (unsafe_shiftl2 n x))
           (fun n x => reduce_3 (unsafe_shiftl3 n x))
           (fun n x => reduce_4 (unsafe_shiftl4 n x))
           (fun n x => reduce_5 (unsafe_shiftl5 n x))
           (fun n x => reduce_6 (unsafe_shiftl6 n x))
           (fun n p x => reduce_n n (unsafe_shiftln n p x)).


 Theorem spec_unsafe_shiftl: forall n x,
  [n] <= [head0 x] -> [unsafe_shiftl n x] = [x] * 2 ^ [n].
 Proof.
 assert (F0: forall x y, x - (x - y) = y).
   intros; ring.
 assert (F2: forall x y z, 0 <= x -> 0 <= y -> x < z -> 0 <= x / 2 ^ y < z).
  ...
  intros ww ww1 ww2 ww_op ww1_op ww2_op xx yy xx1 yy1 Hl Hl1 Hw Hw1 Hw2 Hx Hy.
     ...
     apply Zlt_le_weak.
     case (CyclicAxioms.spec_head0 Hw1 xx).
       rewrite <- Hx; auto.
     ...
     absurd (2 ^  (Zpos (znz_digits ww1_op)) <= 2 ^ (znz_to_Z ww1_op (znz_head0 ww1_op xx))).
       ...
       apply Zmult_le_compat_l; auto with zarith.
     apply Zpower_le_monotone; auto with zarith.
     rewrite (CyclicAxioms.spec_head00 Hw1 xx); auto with zarith.
     ...
     rewrite Hx.
     case (CyclicAxioms.spec_head0 Hw1 xx); auto.
       rewrite <- Hx; auto.
  ...
  assert (F6: forall n, Zpos (znz_digits w6_op) <= Zpos (znz_digits (make_op n))).
    ...
    assert (0 <= Zpos (znz_digits w6_op)); auto with zarith.
    apply F5; auto with arith.
  intros x; case x; clear x; unfold unsafe_shiftl, same_level.
    intros x y; case y; clear y.
     intros y; unfold unsafe_shiftl0, head0.
     repeat rewrite spec_reduce_0; unfold to_Z; intros H1.
       apply F4 with (3:=w0_spec)(4:=w0_spec)(5:=w0_spec); auto with zarith.
     intros y; unfold unsafe_shiftl1, head0.
       repeat rewrite spec_reduce_0; repeat rewrite spec_reduce_1; unfold to_Z; intros H1.
       apply F4 with (3:=w1_spec)(4:=w1_spec)(5:=w0_spec); auto with zarith.
       try (apply sym_equal; exact (spec_extend0n1 x)).
     intros y; unfold unsafe_shiftl2, head0.
       repeat rewrite spec_reduce_0; repeat rewrite spec_reduce_2; unfold to_Z; intros H1.
       apply F4 with (3:=w2_spec)(4:=w2_spec)(5:=w0_spec); auto with zarith.
       try (apply sym_equal; exact (spec_extend0n2 x)).
     intros y; unfold unsafe_shiftl3, head0.
       repeat rewrite spec_reduce_0; repeat rewrite spec_reduce_3; unfold to_Z; intros H1.
       apply F4 with (3:=w3_spec)(4:=w3_spec)(5:=w0_spec); auto with zarith.
       try (apply sym_equal; exact (spec_extend0n3 x)).
     intros y; unfold unsafe_shiftl4, head0.
       repeat rewrite spec_reduce_0; repeat rewrite spec_reduce_4; unfold to_Z; intros H1.
       apply F4 with (3:=w4_spec)(4:=w4_spec)(5:=w0_spec); auto with zarith.
       try (apply sym_equal; exact (spec_extend0n4 x)).
     intros y; unfold unsafe_shiftl5, head0.
       repeat rewrite spec_reduce_0; repeat rewrite spec_reduce_5; unfold to_Z; intros H1.
       apply F4 with (3:=w5_spec)(4:=w5_spec)(5:=w0_spec); auto with zarith.
       try (apply sym_equal; exact (spec_extend0n5 x)).
     intros y; unfold unsafe_shiftl6, head0.
       repeat rewrite spec_reduce_0; repeat rewrite spec_reduce_6; unfold to_Z; intros H1.
       apply F4 with (3:=w6_spec)(4:=w6_spec)(5:=w0_spec); auto with zarith.
       try (apply sym_equal; exact (spec_extend0n6 x)).
     intros m y; unfold unsafe_shiftln, head0.
       repeat rewrite spec_reduce_n; unfold to_Z; intros H1.
       apply F4 with (3:=(wn_spec m))(4:=wn_spec m)(5:=w0_spec); auto with zarith.
       change ([Nn m (extend6 m (extend0 5 x))] = [N0 x]).
       rewrite <- (spec_extend6n m); rewrite <- spec_extend0n6; auto.
    ...
    intros x y; case y; clear y.
     ...
     intros m y; unfold unsafe_shiftln, head0.
       ...
       try (apply sym_equal; exact (spec_extend6n m x)).
    intros n x y; case y; clear y;
     intros y; unfold unsafe_shiftln, head0; try rewrite spec_reduce_n.
     try rewrite spec_reduce_0; unfold to_Z; intros H1.
       apply F4 with (3:=(wn_spec n))(4:=w0_spec)(5:=wn_spec n); auto with zarith.
       rewrite (spec_zdigits w0_spec).
       rewrite (spec_zdigits (wn_spec n)).
